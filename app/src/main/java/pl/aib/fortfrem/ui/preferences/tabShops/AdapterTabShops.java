...
public class AdapterTabShops extends RecyclerView.Adapter<AdapterTabShops.MyViewHolder>{
    Context context;
    ...
    public AdapterTabShops(Context ct, ArrayList<Category> categoriesList){
        this.context = ct;
        this.categoriesAddedList = categoriesList;
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterTabShops.MyViewHolder holder, int position) {
